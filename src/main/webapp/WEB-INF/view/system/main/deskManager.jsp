...
<script type="text/javascript">
    ...
    function getLangDate() {
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${sessionScope.user.realName}，" + timeValue + "好！ 欢迎使用汽车出租系统。当前时间为： " + newDate + "　" + week;
    ...
    layui.use(['element', 'layer', 'jquery', 'form'], function () {
        ...
        //最新文章列表 不写data.data.length会发生数组越界
        $.get("${requestScope.contextPath}/news/findAllNews?page=1&limit=10", function (data) {
            var hotNewsHtml = '';
        ...
        viewNews = function (id) {
            $.get("${requestScope.contextPath}/news/findNewsById?id=" + id, function (news) {
                layer.open({
                    type: 1,
                    title: '查看公告',
