...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="../../../../statics/images/face.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite class="adminName">${sessionScope.user.realName}</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${requestScope.contextPath}/userLogin/toLogin" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a>
                        </dd>
                    </dl>
                </li>
            </ul>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName">${sessionScope.user.realName}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${requestScope.contextPath}/sys/toDeskManager"><i class="layui-icon"
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${requestScope.contextPath}/sys/toDeskManager"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020 liudisi</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${requestScope.contextPath}/menu/loadLeftMenu" //获取菜单json地址
        });
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                '<div class="admin-header-lock-img"><img src="../../../statics/images/face.jpg" class="userAvatar"/></div>'+
                '<div class="admin-header-lock-name" id="lockUserName">${sessionScope.user.realName}</div>'+
                '<div class="input_btn">'+
